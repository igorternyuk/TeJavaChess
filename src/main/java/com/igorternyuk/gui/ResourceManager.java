...
public class ResourceManager {
    ...
    private static final String DEFAULT_PATH_TO_SPRITE_SET = "img/chessPiecesSpriteSet.png";
    ...
    private ResourceManager(){
        try {
            InputStream image = this.getClass().getClassLoader().getResourceAsStream(DEFAULT_PATH_TO_SPRITE_SET);
            this.piecesSpriteSet = ImageIO.read(image);
